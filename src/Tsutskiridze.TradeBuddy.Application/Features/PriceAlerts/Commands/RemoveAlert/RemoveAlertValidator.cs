...
public sealed class RemoveAlertValidator : IValidator<RemoveAlertCommand>
{
    public ValueTask<ValidationResult> ValidateAsync(RemoveAlertCommand obj, CancellationToken cancellationToken)
    {
