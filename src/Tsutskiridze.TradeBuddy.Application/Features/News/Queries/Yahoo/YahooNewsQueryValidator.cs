...
public class YahooNewsQueryValidator : IValidator<YahooNewsQuery>
{
    public ValueTask<ValidationResult> ValidateAsync(YahooNewsQuery obj, CancellationToken cancellationToken)
    {
