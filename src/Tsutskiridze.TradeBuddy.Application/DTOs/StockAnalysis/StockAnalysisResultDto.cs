...
namespace Tsutskiridze.TradeBuddy.Application.DTOs.StockAnalysis
{
    public class StockAnalysisResultDto
    {
        ...
        public StockBenchmarkMetricsDto bench { get; set; }
        ...
        public List<StockSentimentDetailDto> news { get; set; }
    ...
    public class StockBenchmarkMetricsDto
    {
        [Required]
    ...
    public class StockSentimentDetailDto
    {
        [Required]
