...
namespace Tsutskiridze.TradeBuddy.Application.Features.StockAnalysis
{
    ...
    {
        private readonly FinancialModelingPregClient _fmp;
        private readonly NewsService _news;
        private readonly YahooStockScraper _yahooSraper;

        public StockPromptService(FinancialModelingPregClient fmp, NewsService news, YahooStockScraper yahooSraper)
        {
            _fmp = fmp;
            _news = news;
